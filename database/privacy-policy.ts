export const privacyPolicyDatabase = [
  ...
  },
  {
    ...
    description: `Certain circumstances may require ${process.env.NEXT_PUBLIC_WEBSITE_NAME} to share your personal data with certain third parties without notice to You. This may include:Agents, Consultants and Related Third Parties: ${process.env.NEXT_PUBLIC_WEBSITE_NAME} may employ other companies to perform certain business-related functions. This could include mailing information, maintaining databases and processing payments. We only provide these companies information they need to perform their specific function.Business Partners: We may aggregate your personal data along with personal data of other users. This information is used in a non-personally identifiable manner to advertisers and other third parties for marketing and promotional purposes. We will not disclose information that could be used to identify You personally to our business partners.Legal Requirements: If needed, ${process.env.NEXT_PUBLIC_WEBSITE_NAME} may disclose your personal data by law or in good faith that such action is necessary to (a) comply with a legal obligation, (b) protect and defend the rights or property of ${process.env.NEXT_PUBLIC_WEBSITE_NAME}, (c) act in urgent circumstances to protect the personal safety of users of the Site or the public, or (d) protect against legal liability.Business Transfers: Buying or selling businesses or assets is a part of any business, and we are no different. If we affect a corporate sale, merger, reorganization, dissolution or similar event, personal data may be part of the transferred assets.`,
  },
  {
    id: 8,
    title: "Minor",
    description: `${process.env.NEXT_PUBLIC_WEBSITE_NAME} does not knowingly collect personal data from minors under the age of 18 through this Site. If You are under 18, please do not give us any personal data.`,
  },
  {
    id: 9,
  ...
  },
  {
    ...
    description: `Do Get in Touch with us if You have any questions regarding this Privacy Policy or collection of personal data from this Site. Please contact us by going to ${process.env.NEXT_PUBLIC_WEBSITE_URL}/contact and completing the online email form.`,
  },
];
