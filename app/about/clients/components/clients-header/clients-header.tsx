...
const ClientsHeader = () => (
  <div className="py-40 lg:py-[10.5rem] max-w-3xl">
    ...
    <p className="text-black text-md md:text-lg lg:text-xl xl:text-2xl 2xl:text-3xl">
      <Translate value="We take pride in our rich portfolio of working with global brands and turning hundreds of ideas to craft advanced solutions. We have helped 600+ companies transform with world-class software solutions." />
    </p>
  </div>
);
